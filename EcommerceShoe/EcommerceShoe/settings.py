...
# Database - I uses postgres as database
...
DATABASES = {
    'default': {
        ...
        'NAME': 'EcommerceShoe_db',            # database name
        'USER': 'ecommerce_user',              # DB user
        'PASSWORD': 'akshay@123',             
        'HOST': 'localhost',
        'PORT': '5432',
    }
...
# JWT authentication to REST framework configuration:
REST_FRAMEWORK = {
...
from datetime import timedelta             #Token Lifetime
SIMPLE_JWT = {
